...
public class UserTest2 {
	...
	public void testCreateUser() {
		...
		Response response = UserEndpoints2.createUser(userPayload1);
...
//Log
	...
	public void testGeteUser() {
		...
		Response response = UserEndpoints2.getUser(this.userPayload1.getUsername());
	...
	{
		userPayload1.setFirstName(faker.name().firstName());
		Response response = UserEndpoints2.UpdateUser(this.userPayload1.getUsername(),userPayload1);
		...
		Response responseAfterUpdate = UserEndpoints2.getUser(this.userPayload1.getUsername());
	...
	public void testDeleteUser()
	{
		...
		Response response = UserEndpoints2.deleteUser(this.userPayload1.getUsername());
